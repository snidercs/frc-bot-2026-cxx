local config = {
    ...
    turret_uptake_stall_amps = 58.0,      -- Stator current threshold to detect a jam (A) — tune on robot
    turret_uptake_reverse_time = 0.25,    -- How long to run in reverse after a jam (s)
